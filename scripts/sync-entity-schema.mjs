...
function homepageFaqs() {
 ...
 acceptedAnswer: {
 "@type": "Answer",
        text: "Sparklean serves Naples, Bonita Springs, Estero, Fort Myers, and Cape Coral.",
 },
 },
 ];
}
...
function syncHomepage() {
 ...
 url: "https://www.sparklean.co/",
      name: "Full-Service Cleaning Company Naples FL | Sparklean",
...
function syncContact() {
 ...
 description:
 "Request a quote for professionally managed residential and commercial cleaning in Naples, Bonita Springs, Estero, Fort Myers, and Cape Coral.",
 isPartOf: { "@id": WEBSITE_ID },
 about: orgRef(),
 mainEntity: orgRef(),
 publisher: orgRef(),
...
syncServicePage({
 ...
 pageDescription:
 "Professionally managed and supervised residential cleaning across Naples, Bonita Springs, Estero, Fort Myers, Cape Coral.",
 ...
 provider: orgRef(),
 description:
 "Weekly, bi-weekly, or monthly residential cleaning in Naples, Bonita Springs, Estero, Fort Myers, and Cape Coral.",
 },
 },
 {
 "@type": "Offer",
...
syncServicePage({
 ...
 pageDescription:
 "Professionally managed commercial and janitorial cleaning in Naples, Bonita Springs, Estero, Fort Myers, and Cape Coral.",
 ...
 catalogName: "Commercial Cleaning Services",
 offers: [
 {
 "@type": "Offer",
 itemOffered: {
...
syncServicePage({
 ...
 pageDescription:
 "Professionally managed post-construction and final cleaning in Naples, Bonita Springs, Estero, Fort Myers, and Cape Coral.",
...
syncServicePage({
 ...
 pageDescription:
 "Guest-ready vacation rental and Airbnb turnover cleaning in Naples, Bonita Springs, Estero, Fort Myers, and Cape Coral.",
