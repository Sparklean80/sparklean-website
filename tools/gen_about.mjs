...
const basePath = path.join(ROOT, "pages", "specialized-cleaning.html");
...
.ab-tony{background:#151412;border-top:1px solid rgba(,,,.);}
.ab-roxy{background:linear-gradient(180deg,#12110f 0%,#0e0e0e 100%);border-top:1px solid rgba(,,,.);}
.ab-together{background:#131210;border-top:1px solid rgba(,,,.);}
.ab-today{background:var(--dark2);border-top:1px solid rgba(,,,.);}
.ab-outro{padding:clamp(88px,10vw,120px) 80px clamp(100px,12vw,140px);text-align:center;background:radial-gradient(ellipse 70% 45% at 50% 0%,rgba(,,,.) 0%,transparent 55%),#0c0c0c;border-top:1px solid rgba(,,,.);}
.ab-inner{max-width:44rem;margin:0 auto;}
.ab-inner-wide{max-width:52rem;margin:0 auto;}
.ab-prose p{font-family:var(--serif);font-size:1.02rem;line-height:1.92;color:rgba(,,,.);margin-bottom:1.15em;}
.ab-prose p:last-child{margin-bottom:0;}
.ab-prose strong{color:var(--white);font-weight:500;}
.ab-pull{font-family:var(--serif);font-size:1.06rem;line-height:1.78;font-style:italic;color:rgba(,,,.);border-left:2px solid var(--gold);padding:1.15rem 1.35rem 1.15rem 1.5rem;margin:2rem 0;background:linear-gradient(90deg,rgba(,,,.) 0%,transparent 100%);}
.ab-list{list-style:none;margin:0;padding:0;}
.ab-list li{font-family:var(--serif);font-size:.98rem;line-height:1.78;color:rgba(,,,.);padding:.55rem 0 .55rem 1.15rem;border-bottom:1px solid rgba(,,,.);position:relative;}
...
.ab-lux-intro{font-family:var(--serif);font-size:1.02rem;line-height:1.9;color:rgba(,,,.);text-align:center;max-width:40rem;margin:0 auto 40px;}
.ab-lux-stack{max-width:38rem;margin:0 auto;text-align:center;}
.ab-lux-stack p{font-family:var(--serif);font-size:clamp(1.05rem,2.1vw,1.32rem);line-height:1.5;color:rgba(,,,.);margin:0;padding:1.05rem 1rem;border-bottom:1px solid rgba(,,,.);}
...
`;
const fullCss = css + extra;
const ld = `{"@context":"https://schema.org","@type":"AboutPage","name":"About Sparklean Cleaning","url":"https://www.sparklean.co/about","description":"Founded by Tony Giuliano and Roxana Tellez, Sparklean Cleaning delivers elevated residential cleaning in Naples, Bonita Springs, Estero, Fort Myers, and Cape Coral.","mainEntity":{"@type":"LocalBusiness","name":"Sparklean Cleaning","url":"https://www.sparklean.co/","telephone":"+1-239-888-3588","email":"info@sparklean.co","founder":[{"@type":"Person","name":"Tony Giuliano"},{"@type":"Person","name":"Roxana “Roxy” Tellez"}],"areaServed":["Naples FL","Bonita Springs FL","Estero FL","Fort Myers FL","Naples, Bonita Springs, Estero, Fort Myers, and Cape Coral"]}}`;

const body = String.raw`<!DOCTYPE html>
<html lang="en">
<head>
<meta charset="UTF-8">
...
<meta property="og:description" content="Two founders, one standard: elevated residential cleaning, discretion, and consistency in Naples, Bonita Springs, Estero, Fort Myers, and Cape Coral.">
...
<meta property="og:image:alt" content="Sparklean team planning service in a luxury Naples, Bonita Springs, Estero, Fort Myers, and Cape Coral home">
...
<section class="hero hero--about">
 ...
 <div class="hero-tag"><div class="hero-tag-line"></div><span>ABOUT SPARKLEAN</span></div>
 ...
 <div><div class="hs-n">Known</div><div class="hs-l">Teams · Supervision</div></div>
...
<div class="hero-mobile hero-mobile--about">
 ...
 <div class="hero-mobile-tag"><div class="hero-mobile-tag-line"></div><span>ABOUT SPARKLEAN</span></div>
 <h1>About<br><em>Sparklean Cleaning</em></h1>
 <p class="hero-sub">Built from two professional journeys — one belief: people deserve a higher standard of care, professionalism, and trust inside their homes.</p>
 <p class="hero-guar">✦ Bonded · Insured · Workers' Comp · Supervised Teams</p>
 <div class="hero-btns">
...
<section class="ab-today">
 ...
 <h2 class="sec-h" style="margin-bottom:52px;">Five cities, the same<br><em>intentional standard</em></h2>
 <div class="comm-grid">
 <div class="comm-card">
 <div class="comm-city">Where we serve</div>
 <div class="comm-desc">Today, Sparklean Cleaning serves homeowners across <strong>Naples</strong>, <strong>Bonita Springs</strong>, <strong>Estero</strong>, <strong>Fort Myers</strong>, and surrounding Naples, Bonita Springs, Estero, Fort Myers, and Cape Coral communities with a focus on elevated residential cleaning, recurring maintenance, post-construction detailing, and curated add-on services designed for high-standard homes.</div>
 </div>
 <div class="comm-card">
...
<section class="cta" id="quote">
 ...
 <p class="cta-quote">Trusted in Naples, Bonita Springs, Estero, Fort Myers, and Cape Coral</p>
...
const outPath = path.join(ROOT, "pages", "about.html");
