...
export const PAGE_REVIEW_SUBS = {
  "index.html":
    "Homeowners and businesses across Southwest Florida trust Sparklean to maintain their properties to the highest standard. Read current Google reviews on our live profile.",
  "pages/house-cleaning-naples.html":
    "Homeowners and businesses across Southwest Florida trust Sparklean — including Naples homeowners in Port Royal, Pelican Bay, and Park Shore. Read current Google reviews on our live profile.",
  "pages/house-cleaning-bonita-springs.html":
    "Homeowners and businesses across Southwest Florida trust Sparklean — including Bonita Springs homeowners in Bonita Bay, Barefoot Beach, and Pelican Landing. Read current Google reviews on our live profile.",
  "pages/house-cleaning-estero.html":
    "Homeowners and businesses across Southwest Florida trust Sparklean — including Estero homeowners in West Bay Club, Grandezza, and The Brooks. Read current Google reviews on our live profile.",
  "pages/house-cleaning-fort-myers.html":
    "Homeowners and businesses across Southwest Florida trust Sparklean — including Fort Myers homeowners in Gulf Harbour, Crown Colony, and Heritage Palms. Read current Google reviews on our live profile.",
  "pages/house-cleaning-cape-coral.html":
    "Homeowners and businesses across Southwest Florida trust Sparklean — including Cape Coral homeowners in Cape Harbour, Sandoval, and Tarpon Point. Read current Google reviews on our live profile.",
};
...
export function buildGoogleReviewsSection({ sub, pretty = true }) {
  ...
  return [
    ...
    `${ind4}<div><div class="rev-stat-n">SW FL</div><div class="rev-stat-l">Service<br>Area</div></div>`,
